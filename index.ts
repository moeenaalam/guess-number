...
let evenOdd = (num: number): string => num%2==0?"Even":"Odd" //function to check if number is even or odd

let bigSmall = (num1:number, num2:number): string => num1>num2?"Bigger":"Smaller" //check if input is smaller or bigger from random number
